...
class SetupGUI:
    ...
    def load_current_settings(self):
        ...
        self.current_api_key = os.environ.get('NOTION_API_KEY', '')
        self.current_database_id = os.environ.get('NOTION_DATABASE_ID', '')
...
"""
        ...
        try:
            ...
            self.root.destroy()  # quit()ではなくdestroy()を使用
